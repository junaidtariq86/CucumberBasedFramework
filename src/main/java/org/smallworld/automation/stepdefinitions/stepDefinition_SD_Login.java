...
public class stepDefinition_SD_Login extends Base {
    ...
    public void user_is_on_login_page() throws Exception {
        ...
        String WebUrl = ExcelDriven_XLSX.readExcelData("Testdata", "Basic", "URL").get("Value");
    ...
    public void user_login_into_application_using_valid_user_credentials() throws Exception {
        String Username = ExcelDriven_XLSX.readExcelData("Testdata", "Basic", "UserName").get("Value");
        String Password = ExcelDriven_XLSX.readExcelData("Testdata", "Basic", "Password").get("Value");
    ...
    public void locked_user_login_into_application() throws Exception {
        String Username = ExcelDriven_XLSX.readExcelData("Testdata", "UserData", "LockedUserName").get("Value");
        String Password = ExcelDriven_XLSX.readExcelData("Testdata", "UserData", "LockedUserPassword").get("Value");
    ...
    public void locked_user_error_message_is_displayed() throws Exception {
        String expLockedUserError = ExcelDriven_XLSX.readExcelData("Testdata", "UserData", "LockedUserErrorMessage").get("Value");
